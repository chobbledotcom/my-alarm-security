...
title: CCTV
subtitle: >-
  Due to the global shortage of hard drives, prices may vary. Please contact us
  for an up to date quote. CCTV quotes are valid for 7 days due to fluctuations
  in component prices. (August 2026)
...
Our CCTV systems are installed by experienced engineers with a focus on providing the best coverage possible. We understand that cabling can be a concern for some customers, which is why we strive to keep our installations as neat and discreet as possible with minimal cables on show. We are DBS checked and carry full public liability and employers' liability insurance, and we are happy to send our [insurance certificate](/pages/insurance/) over if you or your insurer need to see it.

As technology advances, conventional black and white imaging cameras are being replaced with cameras capable of 24 hour colour imaging. These new cameras with full colour technology have been particularly popular, and we now offer them alongside our most popular [intruder alarm systems](/categories/burglar-alarms/). The 24 hour colour image technology provides full-colour images day and night, using a large iris and high-performance sensor to achieve sharp, valuable images even in low light conditions by lighting up the area when the camera detects that there is not enough ambient light. With full app integration for remote viewing, our CCTV packages offer the latest in smart technology.
