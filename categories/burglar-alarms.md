...
We offer free no obligation survey where we will go through with you the best placements for the sensors so that all entry points are covered - front door, rear doors, bi-folds, windows, hallway, landing, garage etc. We also bring along a demo kit to all of our surveys so that you can see the equipment before making your decision. Pyronix wireless devices are all battery powered. We suggest that batteries in the devices should be replaced every year to avoid any low battery warnings. The panel which is mains powered will also have a back up battery should you ever have a power cut. The external siren - normally placed on the front of the property, will also have a battery. If you are upgrading your system and have a cable in place from an older existing system for an external siren,  we may be able to use this to power the new siren - which will also have a battery back up incase of a power cut. If you do not have a cable in place from an existing system, the new siren can be added wirelessly and will work in the exact same way.
...
Battery changes can be done during an alarm system service. It is recommended to replace device batteries every 12 months and panel and siren batteries every 2 years. 
