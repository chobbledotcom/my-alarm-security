...
Wireless technology has come so far over the years and is now as reliable as a wired home security house alarm or business premises alarm system, but without the disruption of adding cables in and around your property. As technology advances, intruder alarm systems nowadays can be fitted into a property in approx half a day (depending on the size of the property). 95% of the burglar alarm systems we install are wireless. Many years ago, all burglar alarm systems were hard wired systems which meant that carpets and floorboards had to come up to run the cables or wires were run round the ceilings or skirtings and clipped around door frames. Wireless technology since then has come so far. The main control panel for our burglar alarm system will always be hard wired (even with a wireless system). Devices such as door contacts, movement sensors, panic buttons, keypads etc are then added to the system wirelessly. Pyronix systems utilise two-way wireless technology, which ensures reliable, secure, and encrypted communication between devices, including an anti-jamming mechanism - unlike DIY systems which can be purchased in Argos or B&Q that often lack the advanced security and encryption features found in professionally installed systems.

**How much does a Burglar Alarm cost?**

Burglar alarm systems vary in price due to each person's preference and building layout - the amount of sensors you need, the amount of entry points there are etc. We have created some very popular packages starting at £639.00, however we can also tailor create any package to suit your property or requirements. Our [standard package burglar alarm system](/products/standard-system-599/#content) is £699.00 including installation and is the most popular package we install. Additional sensors or devices such as keyfobs, keytags, additional door contacts, vibration sensors, wireless keypad, external movement sensors, [strobe lights](/blog/wireless-sounder-alarm-system-for-the-deaf-or-hard-of-hearing/) for those who are deaf or hard of hearing and panic buttons can also be added to (or removed from) any of our packages.

We offer a free no obligation survey where we will go through with you the best placements for the devices and your requirements so that all entry points are covered - front door, rear doors, bi-folds, windows, hallway, landing, garage etc. We will also bring along a demo kit to all of our surveys so that you can see the equipment before making your decision. All of our alarm systems are professionally installed by experienced engineers and fully demonstrated before completion. We also offer a 12 months parts warranty on all of our installations, so if you experience any issues with any of the sensors or equipment within 12 months, we will replace the part free of charge. We are also DBS checked and carry £1,000,000 public liability insurance, with the full [certificate](/pages/insurance/) on the site if you want to check the cover before booking.

Pyronix wireless devices are all battery powered. We suggest that batteries in the devices should be replaced every 12 months to avoid any low battery warnings - except for the panel and siren batteries which should be replaced every two years. The panel which is mains powered (even on a wireless system) will also have a backup battery should you ever have a power cut. The external siren - normally placed on the front of the property, will also have a battery. If you are upgrading your system and have a cable in place from an older existing system for an external siren,  we may be able to use this to power the new siren - which will also have a battery backup in case of a power cut. If you do not have a cable in place from an existing system, the new siren can be added wirelessly and will work in the exact same way.

We can still install hard wired systems however these are most commonly done during property renovations where the floors and walls have yet to be added and would require at least two visits with the first visit to run the cables (first fix) and then the second visit (second fix) would be done after all of the works are completed and the sensors are ready to be put into their location.

A wireless system is just as reliable as a wired system. All of the devices that are added to the panel will be named ie 'front door' or 'office' etc. If ever there is an issue with one of the sensors, you will be alerted on the panel. The panel displays descriptive messages such as 'low battery on the front door' or 'alarm activation on the office sensor' for example.
